...
def prompt_return(type_learning, few_shot_number=None):
    ...
    if type_learning=='zero':
        ...
        final_prompt=prompt+"Output Format: Respond with either 'Admit to Hospital' or 'Discharge Home'. Do not provide reasoning.\n"
        ...
        final_prompt=prompt+"\n\nOutput Format: Respond with either 'Admit to Hospital' or 'Discharge Home'. Do not provide reasoning."
